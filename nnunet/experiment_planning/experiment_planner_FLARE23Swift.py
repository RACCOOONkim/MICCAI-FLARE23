...
class ExperimentPlanner3D_FLARE23Swift(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_FLARE23Swift, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_FLARE23Swift"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansFLARE23Swift_plans_3D.pkl")
        #input,output_channels
        self.unet_base_num_features = 24

    def get_target_spacing(self):
        # return the desired spacing
        return np.array([3.0, 1.5, 1.5])
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        # set the conv_kernel_sizes, pool_op_kernel_sizes, and input_patch_size
        conv_kernel_sizes = [[3,3,3], [3,3,3], [3,3,3], [3,3,3], [3,3,3], [3,3,3]]
        pool_op_kernel_sizes = [[1,2,2], [2,2,2], [2,2,2]]
