...
class ExperimentPlanner3D_FLARE23Fine(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_FLARE23Fine, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_FLARE23Fine"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansFLARE23Fine_plans_3D.pkl")
        self.unet_base_num_features = 32

    def get_target_spacing(self):
        # return the desired spacing
        return np.array([2.5, 0.8, 0.8]) 
